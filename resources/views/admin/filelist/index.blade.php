...
<section class="content">
    ...
    <div class="card card-default">
        ...
        <div class="card-tools">
          <a href="{{ route('admin.filelist.create') }}" class="btn btn-block bg-gradient-primary">Add File</a>
        </div>
        </div>
        <!-- /.card-header -->
              <div class="card-body">
...
<script>
  ...
  $(document).on('click', '.delete_item', function() {
      ...
      var url = '{{ route("admin.filelist.destroy", ":slug") }}';
      url = url.replace(':slug', dataId);
      console.log(dataValue);
      let message = "You won't be deleted "+dataValue+" ?";
      let icon = 'error';
      let hide = 'Yes, deleted it!'
